<template>
  <div class="tu-transfer-panel">
    ...
    <div
      :class="['tu-transfer-panel__body', hasFooter ? 'is-with-footer' : '']"
    >
      <tu-input
        ...
        v-if="filterable"
      >
        <i slot="prefix" :class="['tu-input__icon', 'tu-icon-search']"></i>
      </tu-input>
      <tu-scrollbar tag="div" class="tu-transfer-panel__wrapper">
        <tu-checkbox-group
          v-model="checked"
        ...
        <p class="tu-transfer-panel__empty" v-show="hasNoMatch">
    ...
    <p class="tu-transfer-panel__footer" v-if="hasFooter">
      <slot></slot>
    </p>
  </div>
</template>
