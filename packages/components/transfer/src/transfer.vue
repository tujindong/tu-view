<template>
  <div class="tu-transfer">
    <transfer-panel
      v-bind="$props"
      ref="leftPanel"
      :data="sourceData"
      :title="titles[0] || t('tu.transfer.titles.0')"
      :default-checked="leftDefaultChecked"
      :placeholder="filterPlaceholder || t('tu.transfer.filterPlaceholder')"
      @checked-change="onSourceCheckedChange"
    >
      <slot name="left-footer"></slot>
    </transfer-panel>
    <div class="tu-transfer__buttons">
      <tu-button
        size="mini"
        :class="['tu-transfer__button', hasButtonTexts ? 'is-with-texts' : '']"
    ...
    <transfer-panel
      ...
      ref="rightPanel"
      :data="targetData"
      :title="titles[1] || t('tu.transfer.titles.1')"
