<template>
  ...
  >
    ...
    <transition name="tu-zoom-in-top" @after-leave="handleDropdownLeave">
      <div
      ...
      >
        ...
        >
          <template v-if="suggestions.length">
            ...
            >
              <span>{{ item.text }}</span>
              <i v-if="item.checked" class="tu-icon-check"></i>
            </li>
          </template>
