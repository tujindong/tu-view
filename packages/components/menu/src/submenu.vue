...
export default {
  ...
  computed: {
    ...
    menuTransitionName() {
      return this.rootMenu.collapse ? "tu-zoom-in-left" : "tu-zoom-in-top";
    },
    opened() {
    ...
    isFirstLevel() {
      ...
      while (parent && parent !== this.rootMenu) {
        if (
          ["TuSubmenu", "TuMenuItemGroup"].indexOf(
  ...
  methods: {
    ...
    handleMouseenter(event, showTimeout = this.showTimeout) {
      ...
      this.dispatch("TuSubmenu", "mouse-enter-child");
      clearTimeout(this.timeout);
    ...
    handleMouseleave(deepDispatch = false) {
      ...
      this.dispatch("TuSubmenu", "mouse-leave-child");
      clearTimeout(this.timeout);
      this.timeout = setTimeout(() => {
      ...
      if (this.appendToBody && deepDispatch) {
        if (this.$parent.$options.name === "TuSubmenu") {
    ...
    const popupMenu = (
      <transition name={menuTransitionName}>
        <div
          ref="menu"
          v-show={opened}
          class={[`tu-menu--${mode}`, popperClass]}
        ...
        >
          <ul
            role="menu"
            class={[
              "tu-menu tu-menu--popup",
              `tu-menu--popup-${currentPlacement}`,
            ]}
