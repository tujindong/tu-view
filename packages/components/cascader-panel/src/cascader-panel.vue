  ...
  methods: {
        ...
        case KeyCode.left:
          ...
          if (preMenu) {
            const expandedNode = preMenu.$el.querySelector(
              '.tu-cascader-node[aria-expanded="true"]'
            );
    ...
    scrollIntoView() {
      ...
      menus.forEach((menu) => {
        ...
        if (menuElement) {
          const container = menuElement.querySelector(".tu-scrollbar__wrap");
          const activeNode =
            menuElement.querySelector(".tu-cascader-node.is-active") ||
            menuElement.querySelector(".tu-cascader-node.in-active-path");
