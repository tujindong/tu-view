<template>
  <transition name="tu-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      ref="popper"
      v-show="visible"
      class="tu-time-range-picker tu-picker-panel tu-popper"
      :class="popperClass"
    >
      <div class="tu-time-range-picker__content">
        <div class="tu-time-range-picker__cell">
          <div class="tu-time-range-picker__header">
            {{ t("tu.datepicker.startTime") }}
          </div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="tu-time-range-picker__body tu-time-panel__content"
          >
            <time-spinner
              ref="minSpinner"
      ...
      <div class="tu-time-panel__footer">
        ...
        <tu-button
          size="mini"
          type="primary"
          class="tu-time-panel__btn confirm"
          @click="handleConfirm()"
