		...
		>
			<div class="tu-picker-panel__body-wrapper">
				...
				<div class="tu-picker-panel__body">
					<div
						class="tu-date-picker__time-header"
						v-if="showTime"
					>
					...
					<div
						...
						:class="{
							'tu-date-picker__header--bordered': currentView === 'year' || currentView === 'month',
						}"
					...
					>
						<button
							...
							class="tu-picker-panel__icon-btn tu-date-picker__prev-btn tu-icon-double-left"
						></button>
						<button
							type="button"
							@click="prevMonth"
							...
							class="tu-picker-panel__icon-btn tu-date-picker__prev-btn tu-icon-left"
						></button>
						<span
						...
						<button
							...
							class="tu-picker-panel__icon-btn tu-date-picker__next-btn tu-icon-double-right"
						></button>
						<button
							type="button"
							@click="nextMonth"
							...
							class="tu-picker-panel__icon-btn tu-date-picker__next-btn tu-icon-right"
						></button>
					</div>
	...
	export default {
		...
		methods: {
			...
			handleTimePick(value, visible, first) {
				...
				this.$nextTick(() => {
					this.$refs.timepicker.setBackgroundColor(this.reference);
				});
			},
