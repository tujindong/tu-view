	...
	>
		...
		>
			<div class="tu-picker-panel__body-wrapper">
				<slot
					name="sidebar"
					class="tu-picker-panel__sidebar"
				></slot>
				<div
					class="tu-picker-panel__sidebar"
					v-if="shortcuts"
				...
				<div class="tu-picker-panel__body">
					<div
						class="tu-date-range-picker__time-header"
						v-if="showTime"
					>
						<span class="tu-date-range-picker__editors-wrap">
							<span class="tu-date-range-picker__time-picker-wrap">
								<tu-input
									size="small"
									:disabled="rangeState.selecting"
									ref="minInput"
									:placeholder="t('tu.datepicker.startDate')"
									class="tu-date-range-picker__editor"
							...
							<span
								class="tu-date-range-picker__time-picker-wrap"
							...
							>
								<tu-input
									...
									class="tu-date-range-picker__editor"
									:disabled="rangeState.selecting"
									:placeholder="t('tu.datepicker.startTime')"
						...
						<span class="tu-date-range-picker__editors-wrap is-right">
							<span class="tu-date-range-picker__time-picker-wrap">
								<tu-input
									...
									class="tu-date-range-picker__editor"
									:disabled="rangeState.selecting"
									:placeholder="t('tu.datepicker.endDate')"
							...
							>
								<tu-input
									...
									class="tu-date-range-picker__editor"
									:disabled="rangeState.selecting"
									:placeholder="t('tu.datepicker.endTime')"
					...
					<div class="tu-picker-panel__content tu-date-range-picker__content is-left">
						<div class="tu-date-range-picker__header">
							<button
								type="button"
								@click="leftPrevYear"
					...
					<div class="tu-picker-panel__content tu-date-range-picker__content is-right">
						<div class="tu-date-range-picker__header">
							<button
								type="button"
								@click="rightPrevYear"
	...
	export default {
		...
		computed: {
			...
			leftLabel() {
				return (
					...
					" " +
					this.t("tu.datepicker.year") +
					" " +
					this.t(`tu.datepicker.month${this.leftDate.getMonth() + 1}`)
				);
			},
			...
			rightLabel() {
				return (
					...
					this.t("tu.datepicker.year") +
					" " +
					this.t(`tu.datepicker.month${this.rightDate.getMonth() + 1}`)
				);
			},
		...
		methods: {
			...
			handleMinTimePick(value, visible, first) {
				...
				this.$nextTick(() => {
					this.$refs.minTimePicker.setBackgroundColor(this.reference);
				});
			},
			...
			handleMaxTimePick(value, visible, first) {
				...
				this.$nextTick(() => {
					this.$refs.maxTimePicker.setBackgroundColor(this.reference);
				});
			},
