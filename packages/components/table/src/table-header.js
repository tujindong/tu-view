import Vue from "vue";
import { hasClass, addClass, removeClass } from "@packages/src/utils/dom";
...
export default {
				...
				<thead class={[{ "is-group": isGroup, "has-gutter": this.hasGutter }]}>
					{this._l(columnRows, (columns, rowIndex) => (
						<tr
							...
							{this.hasGutter ? <th class="tu-table__cell gutter"></th> : ""}
						</tr>
					))}
				</thead>
			</table>
	...
	methods: {
		...
		handleFilterClick(event, column) {
			...
			cell = cell.querySelector(".tu-table__column-filter-trigger") || cell;
