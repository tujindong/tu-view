<template>
  <label
    class="tu-checkbox-button"
    :class="[
      size ? 'tu-checkbox-button--' + size : '',
  ...
  >
    <input
      ...
      class="tu-checkbox-button__original"
      type="checkbox"
      :name="name"
      :disabled="isDisabled"
    ...
    <span
      class="tu-checkbox-button__inner"
