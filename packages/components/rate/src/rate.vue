...
<script>
import { hasClass } from "@packages/src/utils/dom";
import { isObject } from "@packages/src/utils/types";
  ...
  methods: {
    ...
    setCurrentValue(value, event) {
      ...
      if (this.allowHalf) {
        ...
        if (hasClass(target, "tu-rate__item")) {
          target = target.querySelector(".tu-rate__icon");
        }
        if (hasClass(target, "tu-rate__decimal")) {
