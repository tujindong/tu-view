<template>
  <div
    class="tu-tree"
    :class="{
      'tu-tree--highlight-current': highlightCurrent,
  ...
  >
    ...
    <div class="tu-tree__empty-block" v-if="isEmpty">
      <span class="tu-tree__empty-text">{{ emptyText }}</span>
    </div>
    <div
      v-show="dragState.showDropIndicator"
      class="tu-tree__drop-indicator"
      ref="dropIndicator"
    ></div>
  </div>
</template>
  ...
  created() {
    ...
    this.$on("tree-node-drag-over", (event, treeNode) => {
      ...
      const iconPosition = dropNode.$el
        .querySelector(".tu-tree-node__expand-icon")
