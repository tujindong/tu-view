<template>
  <button
    ...
    :class="[
      buttonType ? `tu-button--${buttonType}` : '',
    ...
    @click="handleClick"
  >
    <tu-icon class="tu-icon__loading" name="loading" v-if="loading"></tu-icon>
...
export default {
  ...
  computed: {
    ...
    buttonSize() {
      ...
      return this.isGroup
        ? this._buttonGroup.checkboxGroupSize || temButtonSize
        : temButtonSize;
    },

    buttonType() {
      return this.isGroup ? this._buttonGroup.type : this.type;
    },
  },
